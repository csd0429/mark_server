...
class ExampleSpider(CrawlSpider):
    ...
    for i in range(1,85):
        start_urls.append('http://cugala.com/category/apartment/page/'+str(i))
    for i in range(1,22):
        start_urls.append('http://cugala.com/category/住宅/page/'+str(i))
    for i in range(1,11):
        start_urls.append('http://cugala.com/category/room/page/'+str(i))
    for i in range(1,12):
        start_urls.append('http://cugala.com/category/ideas/page/'+str(i))
    ...
    def get_news_id(self,response,item):
        item['news_id']='CL0'+response.url[-5:]
    ...
    def get_news_date(self,response,item):
        ...
        if news_date:
            ...
            if newsdate>daterange:
                ...
                item['news_date']=news_date[0][:-6]+str(rd)[1:6]
